...
public class GameMaster extends ARepl
{
	...
	public void hello()
	{
		...
		System.out.println("*********************************\n");
		System.out.println("This is the first installment of CECS 277's");
	...
	public void listen()
	{
		...
		if (cGame == 'y' || cGame == 'Y')
		{
			...
			System.out.println("2. Game coming soon");
		...
		if (cGame == 'y' || cGame == 'Y')
		{
			...
			switch(gChoice)
			{
				...
				case 1:
					...
					break;
				case 2:
					System.out.println("\nGame 2 is not available at this time. Please pick another game.");
					break;
				default:

...
public class GameMaster extends ARepl
{
	...
	public void hello()
	{
		...
		System.out.println("*********************************\n");
		System.out.println("This is the fourth installment of CECS 277's");
	...
	public void listen()
	{
		...
		if (cGame == 'y' || cGame == 'Y')
		{
			...
			System.out.println("3. Nim_GUI");
			System.out.println("4. Nim_GUI: Challenge Mode");
			System.out.println("5. Mystery House");
		...
		if (cGame == 'y' || cGame == 'Y')
		{
			...
			switch(gChoice)
			{
				...
				case 2:
					...
					break;
				case 3:
					Nim_GUI nGUI = new Nim_GUI();
					nGUI.setVisible(true);
					break;
				case 4:
					Nim_GUI_L1 nGUI_L1 = new Nim_GUI_L1();
					nGUI_L1.setVisible(true);
					break;
				case 5:

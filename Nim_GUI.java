 ...
 * 
 * Nim_GUI is a graphical user interface of the classic NIM game. Nim_GUI uses
...
public class Nim_GUI extends JFrame implements ActionListener
{
	...
	JLabel m_lbl_hi = new JLabel( "Welcome To NIM!" ); //Introduction
	...
	AiBrain aI; //Computer Player object
	AiBrain.NimMove move; //Returnable object that holds Computer's row and stone choice
	...
	void do_press_brain(JButton bx )
	{
		...
		remove_rows();
		setup_board_rows();
		m_lbl_choice.setText("Choice: Row " + move.getBrainRow() + ", Stone " + move.getBrainStone());
